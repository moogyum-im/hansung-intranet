        ...
        <div className="flex bg-gray-50 min-h-screen p-8 space-x-8">
            ...
            <div className="flex-1" ref={printRef}>
                <div className="bg-white p-10 rounded-xl shadow-lg border">
                    <h1 className="text-2xl font-bold text-center mb-4">사 직 서</h1>
                    ...
                    <div className="space-y-8 text-sm">
                        <div className="mb-8">
                            ...
                            <p className="w-full p-3 border rounded-md h-24 bg-gray-100">{formData.resignationReason}</p>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-x-6 items-end">
                            <div>
                                ...
                                <p className="w-full p-2 border rounded-md bg-gray-100">{formData.resignationDate}</p>
                            </div>
                            <div>
                                <label className="block text-gray-700 font-bold mb-2">주민등록번호</label>
                                <p className="w-full p-2 border rounded-md bg-gray-100">{formData.residentId}</p>
                            </div>
                        </div>
                        <div className="pt-8 text-center">
                            <p>{new Date(doc.created_at).getFullYear()}년 {new Date(doc.created_at).getMonth() + 1}월 {new Date(doc.created_at).getDate()}일</p>
                            <p className="mt-4">성 명: {formData.requesterName} (인)</p>
                        </div>
                        ...
                        <div className="border-t pt-4 mt-4">
                            {isFinalApprover && (
                                <div className="mb-4">
                                    ...
                                    <input type="text" value={manualDocNumber} onChange={(e) => setManualDocNumber(e.target.value)} placeholder="예: 인사-2025-001" className="w-full p-2 border border-blue-300 rounded-md" />
                                </div>
                            )}
