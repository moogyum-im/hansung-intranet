        ...
        const setupPage = async () => {
            if (doc) {
                try {
                    ...
                    let rawFiles = doc.attachments || parsedContent.attachments || [];
            ...
            <div className="w-full max-w-[1100px] grid grid-cols-1 lg:grid-cols-12 gap-6 items-start font-black text-black">
                <div className="lg:col-span-8 bg-white border border-black p-10 sm:p-14 shadow-sm relative print-container font-black">
                    <header className="mb-10 border-b-4 border-black pb-6 font-black print-section font-black">
                        <h1 className="text-4xl font-black text-center mb-6 tracking-[1.5rem] uppercase font-black">사직서</h1>
                    ...
                    <div className="space-y-12 text-black font-black">
                        ...
                        <section className="print-section font-black text-black font-black font-black">
                            <h2 className="text-[10px] mb-3 uppercase tracking-tighter border-l-4 border-black pl-2 font-black font-black">01. 퇴직 상세 사유</h2>
                            <div className="border border-black p-5 text-[12px] leading-relaxed min-h-[150px] whitespace-pre-wrap font-black font-black">{formData.resignationReason}</div>
                        </section>

                        <section className="border-4 border-double border-black p-8 space-y-6 font-black bg-slate-50/30 print-section font-black font-black">
                            <h3 className="font-black text-center text-lg underline underline-offset-8">서 약 서</h3>
                            <div className="space-y-4 text-[11px] leading-relaxed font-black font-black">
                            ...
                            <table className="w-full border-collapse border border-black text-[11px] font-black font-black">
                                <tbody>
                                    <tr className="border-b border-black font-black">
                                        ...
                                        <th className="bg-slate-50 p-4 w-28 text-left border-r border-black font-black uppercase font-black">문서번호</th>
                                        {/* 🚀 [수정] 표 내부 문서번호 영역 */}
                        ...
                        <div className="pt-20 text-center space-y-6 print-section font-black text-black font-black">
                            <div className="space-y-4 font-black">
                                ...
                                <p className="text-2xl font-black uppercase tracking-[0.4em] mt-6 font-black font-black">신청인: {doc.requester_name} (인)</p>
                            </div>
                        </div>
                    </div>
                </div>
