            ...
            <div className="w-full max-w-[1100px] grid grid-cols-1 lg:grid-cols-12 gap-6 items-start font-black text-black">
                <div className="lg:col-span-8 bg-white border border-black p-10 sm:p-14 shadow-sm relative print-container text-black font-black font-black font-black">
                    ...
                    <div className="flex justify-between items-start mb-10 border-b-4 border-black pb-8 font-black font-black">
                        ...
                        <div className="flex flex-col items-end gap-2 font-black font-black font-black font-black">
                            <table className="approval-table border-collapse border border-black text-[11px] font-black font-black">
                                <tbody>
                                    <tr className="font-black font-black">
                                        <th rowSpan="3" className="w-8 bg-slate-50 border border-black p-2 font-black text-center leading-tight font-black font-black">결<br/>재</th>
                                        <th className="w-16 h-8 bg-slate-50 border border-black p-1 text-center font-black font-black">기안</th>
                                    ...
                                    <tr className="h-20 font-black font-black">
                                        <td className="border border-black p-1 text-center relative align-middle font-black font-black">
                                            ...
                                            <div className="mt-1 font-black text-[9px] font-black font-black font-black">{doc.requester_name}</div>
                                        </td>
                                        {approvalHistory?.map((step) => (
                                            <td key={step.id} className="border border-black p-1 text-center relative align-middle font-black font-black font-black">
                                                {step.status === '승인' || step.status === '완료' ? (
                                                    ...
                                                    <div className="flex flex-col items-center font-black font-black">
                                                        <div className="text-rose-500 font-black border-2 border-dashed border-rose-500 rounded-full w-14 h-14 flex items-center justify-center mx-auto rotate-[-15deg] text-[10px] leading-tight font-black uppercase font-black">
                                                    ...
                                                    <div className="flex flex-col items-center font-black">
                                                        <div className="text-slate-200 font-black border-2 border-dashed border-slate-100 rounded-full w-14 h-14 flex items-center justify-center mx-auto text-[9px] leading-tight uppercase italic font-black font-black">
                                                            대기중
                                                        </div>
                            ...
                            {['진행중', 'pending', '대기'].includes(doc.status) && currentStep && (
                                <div className="bg-blue-50 border border-blue-200 text-blue-700 px-3 py-1.5 rounded text-[11px] font-black flex items-center gap-1.5 shadow-sm mt-2 no-print font-black">
                    ...
                    <div className="space-y-12 text-black font-black font-black font-black font-black">
                        <table className="w-full border-collapse border border-black text-[11px] font-black print-section font-black font-black font-black">
                            <tbody>
                                <tr className="border-b border-black text-black font-black font-black font-black">
                                    <th className="bg-slate-50 p-4 w-28 text-left border-r border-black font-black uppercase font-black font-black">기안부서</th>
                                    <td className="p-4 border-r border-black font-black font-black font-black font-black font-black">{doc.requester_department}</td>
                                    <th className="bg-slate-50 p-4 w-28 text-left border-r border-black font-black uppercase font-black font-black">기안자</th>
                                    <td className="p-4 font-black font-black font-black font-black">{doc.requester_name} {doc.requester_position}</td>
                                </tr>
                            </tbody>
                        </table>

                        <section className="print-section font-black text-black font-black font-black font-black font-black font-black font-black">
                            <h2 className="text-[10px] mb-3 uppercase tracking-tighter border-l-4 border-black pl-2 font-black font-black font-black font-black font-black">01. 결재 건명</h2>
                        ...
                        <div className="pt-20 text-center space-y-6 print-section font-black text-black font-black font-black font-black font-black font-black font-black font-black">
                ...
                <aside className="lg:col-span-4 space-y-5 no-print font-black font-black font-black font-black">
                            ...
                            {approvalHistory?.map((step, idx) => step.comment && (
                                <div key={idx} className="flex gap-3 p-4 bg-slate-50 rounded-2xl border border-slate-100 font-black font-black font-black font-black font-black font-black font-black font-black">
                                    ...
                                    <div className="font-black font-black">
                                        <p className="text-[10px] text-slate-400 font-black mb-1 font-black font-black font-black font-black font-black font-black font-black font-black">{step.approver?.full_name} {step.approver?.position}</p>
                    ...
                    {isMyTurn && (
                        <div className="bg-slate-900 border border-black rounded-2xl p-6 shadow-xl text-white font-black font-black font-black font-black font-black font-black font-black font-black font-black font-black">
                            ...
                            <textarea 
                                ...
                                className="w-full bg-slate-800 border border-slate-700 rounded-xl p-4 text-[12px] font-black outline-none mb-4 h-28 focus:border-white transition-all text-white placeholder-slate-500 font-black font-black font-black font-black font-black font-black" 
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm text-black font-black font-black font-black font-black font-black font-black font-black font-black font-black">
                        <div className="flex items-center justify-between mb-4 border-b border-slate-100 pb-2 text-black font-black font-black font-black font-black font-black">
                            <h2 className="text-[13px] uppercase font-black flex items-center gap-2 font-black font-black font-black font-black font-black font-black font-black"><Paperclip size={14} /> 증빙 자료 및 첨부파일</h2>
                        ...
                        {attachmentSignedUrls.length > 0 ? (
                            <div className="grid grid-cols-1 gap-2 font-black font-black font-black font-black font-black">
                                {attachmentSignedUrls.map((file, i) => (
                                    <div key={i} className="flex flex-col border border-slate-100 rounded-lg overflow-hidden bg-slate-50 shadow-sm font-black font-black font-black font-black font-black font-black">
                                        <div className="flex items-center justify-between p-2 bg-white border-b border-slate-100 font-black font-black font-black font-black font-black">
                                            <div className="flex items-center gap-2 flex-1 truncate font-black font-black font-black font-black font-black font-black font-black">
                                                {file.name.match(/\.(jpg|jpeg|png|gif|webp)$/i) ? <ImageIcon size={14} className="text-blue-500 font-black font-black font-black" /> : <FileText size={14} className="text-slate-400 font-black font-black font-black font-black" />}
                                                <span className="text-[10px] font-black truncate font-black font-black font-black font-black">{file.name}</span>
                                            </div>
                                            <a href={file.url} download={file.name} target="_blank" rel="noreferrer" className="text-blue-600 hover:bg-blue-100 p-1 rounded bg-white border border-blue-200 font-black font-black font-black font-black font-black">
                                                <Download size={14} />
                                            </a>
                                        </div>
                            ...
                            <div className="py-10 text-center border-2 border-dashed border-slate-50 rounded-xl font-black font-black font-black font-black font-black font-black font-black font-black font-black font-black">
                                ...
                                <p className="text-[10px] text-slate-300 font-black italic uppercase font-black font-black font-black font-black font-black font-black font-black">No Attachments</p>
                            </div>
                        )}
                    </div>
                </aside>
