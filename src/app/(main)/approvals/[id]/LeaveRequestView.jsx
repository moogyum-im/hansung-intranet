                            ...
                            {displayApprovals.map((step, idx) => step.comment && (
                                <div key={idx} className="flex gap-3 p-4 bg-slate-50 rounded-2xl border border-slate-100 font-black font-black font-black">
                                    ...
                                    <div className="font-black">
                                        <p className="text-[10px] text-slate-400 font-black mb-1 font-black font-black">{step.approver?.full_name || step.approver_name} {step.approver?.position}</p>
                            ...
                            <div className="grid grid-cols-1 gap-2 font-black font-black font-black font-black">
                                {attachmentSignedUrls.map((file, i) => (
                                    <div key={i} className="flex flex-col border border-slate-100 rounded-lg overflow-hidden bg-slate-50 shadow-sm font-black font-black font-black font-black font-black">
                                        <div className="flex items-center justify-between p-2 bg-white border-b border-slate-100 font-black font-black font-black font-black">
                                            <div className="flex items-center gap-2 flex-1 truncate font-black font-black font-black font-black font-black font-black">
                                        ...
                                        {file.name.match(/\.(jpg|jpeg|png|gif|webp)$/i) && (
                                            <div className="p-2 flex justify-center bg-slate-50 font-black font-black font-black font-black font-black font-black">
