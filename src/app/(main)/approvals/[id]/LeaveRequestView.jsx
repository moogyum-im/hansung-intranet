    ...
    return (
        <div className="bg-[#f2f4f7] min-h-screen p-4 sm:p-6 flex flex-col items-center font-sans text-black font-black leading-none print:bg-white print:p-0 font-black font-black">
            ...
            <div className="w-full max-w-[1100px] mb-4 flex justify-between items-center no-print px-2 font-black font-black">
                <span className="text-[10px] uppercase tracking-widest font-black text-slate-400">Leave Approval Viewer</span>
                <button onClick={() => window.print()} className="flex items-center gap-2 px-4 py-2 bg-black text-white hover:bg-slate-800 text-[11px] transition-all font-black shadow-lg font-black font-black font-black font-black"><Printer size={14} /> 인쇄 및 PDF 저장</button>
            </div>
            ...
            <div className="w-full max-w-[1100px] grid grid-cols-1 lg:grid-cols-12 gap-6 items-start font-black text-black font-black">
                <div className="lg:col-span-8 bg-white border border-black p-10 sm:p-14 shadow-sm relative print-container font-black font-black">
                    <header className="mb-10 border-b-4 border-black pb-6 font-black print-section font-black">
                        <h1 className="text-3xl font-black tracking-tighter uppercase font-black font-black font-black">휴 가 신 청 서</h1>
                    ...
                    <div className="space-y-12 text-black font-black font-black">
                        ...
                        <section className="print-section font-black text-black font-black font-black">
                            <h2 className="text-[10px] mb-3 uppercase tracking-tighter border-l-4 border-black pl-2 font-black font-black font-black">01. 휴가 세부 내역</h2>
                            <table className="w-full border-collapse border border-black text-[11px] font-black font-black font-black">
                                <tbody>
                                    <tr className="border-b border-black text-black font-black">
                                        ...
                                        <td className="p-4 border-r border-black font-black font-black font-black">{formData.leaveType}</td>
                                        <th className="bg-slate-50 p-4 w-28 text-left border-r border-black font-black uppercase font-black">신청일수</th>
                                        <td className="p-4 font-black font-black font-black text-blue-700">{formData.duration}</td>
                                    </tr>
                                    <tr className="border-b border-black text-black font-black font-black">
                                        ...
                                        <td className="p-4 font-mono font-black font-black font-black">{formData.endDate}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </section>
                        ...
                        <section className="print-section font-black text-black font-black font-black font-black">
                            <h2 className="text-[10px] mb-3 uppercase tracking-tighter border-l-4 border-black pl-2 font-black font-black font-black">02. 휴가 사유</h2>
                        ...
                        {/* [픽스] 서명란 위 03번 증빙 자료 갤러리 */}
                        {attachmentSignedUrls.length > 0 && (
                            <section className="print-section font-black text-black pt-6 font-black font-black font-black">
                                ...
                                <div className="space-y-8 font-black font-black">
                                    {attachmentSignedUrls.map((file, i) => (
                                        <div key={i} className="print-break border border-slate-200 p-2 bg-white rounded-sm print-section font-black font-black">
                                            ...
                                            <img src={file.url} alt={file.name} className="w-full h-auto block shadow-sm font-black font-black font-black font-black" />
                                        </div>
                                    ))}
                                </div>
                            </section>
                        ...
                        <div className="pt-20 text-center space-y-6 print-section font-black text-black font-black font-black">
                ...
                <aside className="lg:col-span-4 space-y-5 no-print font-black font-black font-black font-black">
                    {isReferrer && (
                        <div className="bg-white border border-black p-6 shadow-sm font-black text-black font-black font-black font-black">
                            <div className="flex gap-2 font-black font-black font-black font-black font-black">
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm text-black font-black font-black font-black font-black font-black">
                        <div className="flex items-center gap-2 mb-4 border-b border-slate-100 pb-2 text-black font-black font-black font-black font-black">
                            <Users size={16} /><h2 className="text-[11px] uppercase font-black text-black font-black font-black font-black font-black">결재 프로세스</h2>
                        </div>
                    ...
                    {isMyTurn && (
                        <div className="bg-slate-900 border border-black rounded-2xl p-6 shadow-xl text-white font-black font-black font-black font-black font-black font-black">
                            <h3 className="text-[11px] uppercase mb-4 font-black text-slate-400 font-black font-black font-black font-black">결재 의견 작성</h3>
                            <textarea value={approvalComment} onChange={(e) => setApprovalComment(e.target.value)} className="w-full bg-slate-800 border border-slate-700 rounded-xl p-4 text-[12px] font-black font-black font-black outline-none mb-4 h-28 focus:border-white transition-all text-white placeholder-slate-500 font-black font-black font-black" placeholder="의견을 입력하십시오." />
                            <div className="grid grid-cols-2 gap-3 font-black font-black font-black font-black">
                                ...
                                <button onClick={() => handleApprovalAction('반려')} className="bg-rose-600 text-white py-3 rounded-xl text-[11px] font-black hover:bg-rose-700 transition-all flex items-center justify-center gap-2 font-black font-black font-black font-black font-black"><XCircle size={14}/> 반려</button>
                            </div>
                        </div>
                    )}
                </aside>
