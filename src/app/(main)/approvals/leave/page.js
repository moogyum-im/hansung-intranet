...
export default function LeaveRequestPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (attachmentFile) {
            ...
            const safeFileName = `${uuidv4()}.${fileExt}`; // 랜덤이름.hwp
            
            const { data: uploadData, error: uploadError } = await supabase
                .storage
                .from('approval-documents')
                .upload(safeFileName, attachmentFile);
            ...
            originalFileName = attachmentFile.name; // 원본 파일 이름 저장
        }
        ...
        const submissionData = {
            ...
            attachment_filename: originalFileName, // 원본 파일 이름 추가
        };
    ...
    return (
        <div className="flex bg-gray-50 min-h-screen p-8 space-x-8">
            <div className="flex-1"><div className="bg-white p-10 rounded-xl shadow-lg border">
